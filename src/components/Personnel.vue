  ...
  methods: {
      ...
      this.$swal
        ...
        .then((result) => {
          ...
          if (result.isConfirmed) {
            ...
            this.CatchDate();
            this.Perosnnel_Employee.Name =
              document.getElementById("Employee_Name").value;
            this.Perosnnel_Employee.Account =
              document.getElementById("Employee_Acount").value;
            this.Perosnnel_Employee.Password =
              document.getElementById("Employee_Password").value;
            this.Perosnnel_Employee.AccountLevel =
              document.getElementById("Employee_Level").value;
            this.Perosnnel_Employee.Department = document.getElementById(
              "Employee_Department"
            ).value;
    ...
    InsertArticle: function () {
      ...
      for (let [key, value] of Object.entries(this.Perosnnel_Article)) {
        if (value == "") {
          if (
            this.Perosnnel_Article.ArticleClass == "" ||
            this.Perosnnel_Article.ArticleTitle == "" ||
            this.Perosnnel_Article.ArticleContext == "" ||
            this.Perosnnel_Article.ArticleCreate == "" ||
            this.Employee_Login_Object.Name == "" ||
    ...
    */
    ...
    FileUpload: function () {
      if (this.UpLoads.has("file")) {
        ...
        axios
          .post(this.Personnel_Api_Url + "Personnel/UpLoad", this.UpLoads, {
            headers: {
    ...
    Quick_Search: function () {
      this.$store.dispatch(
        "Quick_Search",
        this.Perosnnel_Article.Article_quick_Search
      );
    },
    ...
    POSTArticle: function () {
      ...
      if (InserCheck == true) {
        this.Perosnnel_Article.Article_Session_Account =
          this.Employee_Login_Object.Account;
        this.Perosnnel_Article.Article_Session_Name =
          this.Employee_Login_Object.Name;
        axios
