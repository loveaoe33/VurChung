<template>
  ...
  <input type="textbox" class="form-control Quick_Search" @keyup="Quick_Search" v-model="Perosnnel_Article.Article_quick_Search" width="50px" id="FormTitle"  placeholder="快搜"><br>
